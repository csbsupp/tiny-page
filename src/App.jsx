      ...
      <header className="relative overflow-hidden border-b border-slate-200 bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-16 lg:px-8 lg:py-24">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <h2 className="mt-2 text-3xl font-semibold tracking-tight">So funktionieren KI-Journeys</h2>
            <p className="mt-4 text-lg text-slate-600">
              Eine KI-Journey ist kein komplizierter Befehl, sondern ein geführter Dialog.
        ...
        <section id="journeys"><div className="mb-8 rounded-2xl border border-amber-300 bg-amber-50 p-4 text-sm text-amber-900">
          ...
          <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-semibold tracking-tight">HUG KI-Journeys</h2>
